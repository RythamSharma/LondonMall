      ...
      >
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-white md:dark:bg-white dark:border-gray-700">
            <li>
              <a
                href="/"
                className="block py-2 pl-3 pr-4 text-black col-p text-xl rounded md:bg-transparent  md:p-0 md:dark:text-[#cb8161]"
                aria-current="page"
                onClick={closeMenu} 
              >
                Home
            ...
            <Link to="/About">
              <li
              onClick={closeMenu}  
              className="block py-2 pl-3 pr-4 text-black rounded col-p text-xl hover:bg-[#cb8161] md:hover:bg-transparent md:hover:text-[#FFD700] md:p-0 md:dark:hover:text-[#cb8161] dark:text-black dark:hover:bg-[#cb8161] dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 transition-colors duration-200 ease-in-out ">
                About
              </li>
            </Link>
            <li>
